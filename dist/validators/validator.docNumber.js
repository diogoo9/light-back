...
exports.IsDOcNumber = IsDOcNumber;
const class_validator_1 = require("class-validator");
function IsDOcNumber(validationOptions) {
            ...
            validator: {
                validate(value, args) {
                    ...
                    if (docNumbers.length == 14) {
                        ...
                        for (var i = 0, n = 0; i < 12; n += docNumbers[i] * CNPJValidationDigits[++i])
                            ;
                        if (docNumbers[12] != ((n %= 11) < 2 ? 0 : 11 - n))
                            return false;
                        for (var i = 0, n = 0; i <= 12; n += docNumbers[i] * CNPJValidationDigits[i++])
                            ;
                        if (docNumbers[13] != ((n %= 11) < 2 ? 0 : 11 - n))
                            return false;
                        return true;
                    }
                    return false;
...
//# sourceMappingURL=validator.docNumber.js.map